...
# Reading in data
spec_lib <- read.csv("./Spectral_Library/Puglielli_complete_library_20180927.csv")
...
#write.table(spec_lib_isotope, file = "./Spectral_Library/AT1_complete_MQ_library_inflated_LABEL.csv", sep = ",", row.names = FALSE)
