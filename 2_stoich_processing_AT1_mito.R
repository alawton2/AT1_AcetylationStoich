...
data <- read.csv("./SpectronautRaw/20181023_DenuPuglielli_mito_Spectronaut10_stoich_Report.csv")
...
#write.table(pep_sum, file = "./Cleaned/20181016_AT1_mito_tidy_peptide_stoich_output.csv", sep = ",", row.names = FALSE)
...
ggplot(subset(frg_sum, stoich_corr < 1), aes(as.factor(sample_id), stoich_corr)) +
